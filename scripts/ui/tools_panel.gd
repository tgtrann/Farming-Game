...
#TODO: Ensure that user can't switch tools through arrow inputs or when the player is walking
#TODO: Switching tools seems to have a delay with the previous tool
